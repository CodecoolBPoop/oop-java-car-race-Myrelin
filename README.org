...
#+BEGIN_SRC java
  ...
  Car
   ...
   static setSpeedLimit(int limit) // Call this from the Race class!
   speed // the normal speed of the car. Set to a random number in the constructor between 80-110km/h.
   ...
   moveForAnHour() // The vehicle travels for an hour. It increases the distance traveled. Call this from the Race class only!
